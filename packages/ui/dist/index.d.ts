...
interface ArcadeRevenueCardProps {
    /** 店铺名称 */
    storeName: string;
    /** 统计日期 */
    date: string;
 ...
 * 含日营收目标进度条
 */
declare function ArcadeRevenueCard({ storeName, date, machines, dailyRevenueTarget, footer, className, }: ArcadeRevenueCardProps): React__default.JSX.Element;
...
declare function AuditTimeline({ events, maxHeight, emptyText, 'data-testid': testId, }: AuditTimelineProps): React__default.JSX.Element;
 ...
 */
declare function Dialog({ open, title, children, footer, onClose, size, closeOnOverlay, closeOnEscape, showCloseButton, showOverlay, style, ariaLabel, 'data-testid': testId, }: DialogProps): React__default.JSX.Element | null;
 ...
 * </ActionPanel>
 */
declare function ActionPanel({ title, subtitle, actions, children, loading, collapsed, onToggleCollapse, className, style, emptyContent, headerExtra, }: ActionPanelProps): React__default.JSX.Element;
...
/** 词云字体生成策略 */
type WordCloudFontStrategy = 'normal' | 'bold' | 'light' | 'italic' | 'bold-italic';
/** 词云布局方向 */
type WordCloudLayout = 'horizontal' | 'mixed';
/** 词云组件 Props */
 ...
 * />
 */
declare function WordCloudChart({ data, width, height, title, minFontSize, maxFontSize, fontStrategy, layout, showLegend, className, emptyText, onWordClick, }: WordCloudChartProps): React__default.JSX.Element;
...
interface AIAgentPerformancePanelProps {
    /** 面板标题 */
    title?: string;
    /** 性能摘要 */
...
declare function AIAgentPerformancePanel({ title, summary, metrics, latencyBuckets, className, loading, emptyText, }: AIAgentPerformancePanelProps): React__default.JSX.Element;
...
interface AnomalyAlertTrendPanelProps {
    /** 趋势数据 */
...
declare const AnomalyAlertTrendPanel: React__default.FC<AnomalyAlertTrendPanelProps>;
...
/** 加盟运营总览指标 */
interface FranchiseOverviewMetrics {
    totalStores: number;
    normalStores: number;
...
/** 加盟运营经理工作台 Props */
interface FranchiseOperationsDashboardProps {
    /** 门店列表 */
    stores?: FranchiseStore[];
    /** 巡查任务 */
    inspectionTasks?: InspectionTask$2[];
    /** 支持请求 */
...
declare function FranchiseOperationsDashboard({ stores, inspectionTasks, supportRequests, storeRankings, overview, regions, brandName, lastUpdatedAt, loading, compact, className, onViewStore, onViewInspection, onHandleSupportRequest, onRefresh, onExportRankings, }: FranchiseOperationsDashboardProps): React__default.JSX.Element;
...
/** 场地主管工作台 props */
interface VenueSupervisorDashboardProps {
...
declare function VenueSupervisorDashboard({ zoneDevices, traffic, revenue, alerts, shiftName, onViewZone, onViewTraffic, onOpenReport, onHandleAlert, onStartPatrol, }: VenueSupervisorDashboardProps): React__default.JSX.Element;
 ...
 */
declare function ProgressSegments({ segments, total: totalProp, height, radius, showLabels, className, 'data-testid': testId, }: ProgressSegmentsProps): React__default.JSX.Element;
...
type InlineNotificationType = 'info' | 'success' | 'warning' | 'error';
 ...
 */
declare function InlineNotification({ type, title, message, closable, onClose, action, 'data-testid': dataTestId, className, style, }: InlineNotificationProps): React__default.JSX.Element | null;
...
/** 采购订单面板操作回调 */
interface PurchaseOrderPanelActions {
...
declare function PurchaseOrderPanel({ order, actions, loading }: PurchaseOrderPanelProps): React__default.JSX.Element;
...
/** 产品增长指标 */
interface ProductGrowthMetrics {
    /** 产品总数 */
...
declare function ProductManagerDashboard({ managerName, lastSyncAt, metrics, products, categoryStats, quickActions, monthlyGoal, launchedThisMonth, loading, compact, }: ProductManagerDashboardProps): React__default.JSX.Element;

/** 单条利润率记录 */
interface ProfitMarginRecord {
    /** 维度标识 */
    id: string;
    /** 维度名称 (产品线/门店/品类) */
    label: string;
...
/** 利润率面板属性 */
interface ProfitMarginPanelProps {
    /** 标题 */
    title?: string;
    /** 总体收入 */
    totalRevenue: number;
 ...
 * 适合店长工作台、财务分析等场景。
 */
declare function ProfitMarginPanel({ title, totalRevenue, totalCost, overallMargin, marginChange, records, costBreakdown, loading, error, periodLabel, }: ProfitMarginPanelProps): React__default.JSX.Element;
...
declare function LoadingOverlay({ visible, mode, label, children, spinnerSize, spinnerVariant, opacity, className, style, }: LoadingOverlayProps): React__default.JSX.Element | null;
...
/** Member tier level */
type TierLevel = 'diamond' | 'platinum' | 'gold' | 'silver' | 'bronze' | 'standard';
/** Single tier segment */
interface TierData {
    key: string;
    label: string;
...
interface TierDistributionParams {
    groupId?: string;
    startDate?: string;
    endDate?: string;
}
 ...
 */
declare function useTierDistribution(params?: TierDistributionParams): UseTierDistributionResult;

/** Default mock member tier data */
declare const MOCK_TIER_DATA: TierData[];
/** Total count derived from mock data */
declare const MOCK_TIER_TOTAL: number;
...
declare function OfflineBadge({ status, pendingCount, onRetry, showIcon, style, autoHideOnlineMs, 'data-testid': dataTestId, }: OfflineBadgeProps): React__default.JSX.Element | null;
 ...
 */
declare function FloatingActionButton({ icon, onClick, position, size, badge, badgeMax, backgroundColor, color, hoverBackgroundColor, label, labelPosition, tooltip, disabled, className, style, 'aria-label': ariaLabel, 'data-testid': dataTestId, }: FloatingActionButtonProps): React__default.JSX.Element;
...
/** AI 会员分群面板 Props */
interface AIMemberSegmentationPanelProps {
    /** 分群列表 */
 ...
 * />
 */
declare function AIMemberSegmentationPanel({ segments, analysis, title, emptyText, onSegmentClick, onViewDetails, className, 'data-testid': dataTestId, }: AIMemberSegmentationPanelProps): React__default.JSX.Element;
...
/** 决策因素类型 */
type FactorType = 'positive' | 'negative' | 'neutral';
/** 决策因素权重 */
...
/** 组件 Props */
interface AIDecisionExplainerPanelProps {
    /** 可解释性数据 */
...
declare function AIDecisionExplainerPanel({ data, title, collapsible, defaultExpanded, variant, }: AIDecisionExplainerPanelProps): React__default.JSX.Element;

type DecisionStatus = 'approved' | 'rejected' | 'pending_review';
interface ImpactMetric {
    label: string;
    value: string;
    trend?: 'up' | 'down' | 'neutral';
}
interface AIDecisionOutcomeCardProps {
    /** 唯一标识 */
    id: string;
    /** 决策标题 */
    title: string;
...
declare function AIDecisionOutcomeCard({ id, title, status, confidence, decidedAt, decidedBy, summary, impactMetrics, suggestedActions, onClick, className, }: AIDecisionOutcomeCardProps): React__default.JSX.Element;
 ...
 * />
 */
declare function AsyncSelect({ loadOptions, value, onChange, placeholder, searchPlaceholder, loadingText, notFoundContent, minWidth, disabled, allowClear, debounceMs, className, style, name, error, loadOnOpen, 'aria-label': ariaLabel, }: AsyncSelectProps): React__default.JSX.Element;
...
type DecisionCategory = 'pricing' | 'inventory' | 'promotion' | 'staff_scheduling' | 'customer_service' | 'content_generation' | 'member_retention' | 'anomaly_response';
interface DecisionDistributionItem {
    /** 决策类别 */
...
interface AIDecisionDistributionPanelProps {
    /** 分布数据 */
...
declare function AIDecisionDistributionPanel({ items, title, loading, emptyText, filterCategory, onCategoryFilter, onItemClick, className, 'data-testid': dataTestId, }: AIDecisionDistributionPanelProps): React__default.JSX.Element;
...
declare function ChartExportPanel({ title, children, csvData, csvFilename, enableFullscreen, enableRefresh, timeRange, activeTimeRange, onTimeRangeChange, onRefresh, extraActions, className, }: ChartExportPanelProps): React__default.JSX.Element;

/** 告警严重级别 */
type AlertSeverity = 'critical' | 'high' | 'medium' | 'low';
/** 告警来源类型 */
type AlertSource = 'device' | 'member' | 'transaction' | 'system' | 'network';
/** AI 分析置信度 */
...
/** AI 关联分析结果 */
interface AlertCorrelationGroup {
    /** 关联组 ID */
    groupId: string;
    /** 关联根因分析 */
    rootCause: string;
...
/** AI 告警关联仪表板 Props */
interface AlertCorrelationDashboardProps {
    /** 原始告警列表 */
...
declare function AlertCorrelationDashboard({ alerts, correlationGroups, title, onAcknowledgeAlert, onAcknowledgeGroup, onExecuteAction, onViewDetail, className, }: AlertCorrelationDashboardProps): React__default.JSX.Element;
...
declare function resolveBreakpoint(width: number): BreakpointKey;
...
declare const useResponsive: () => ResponsiveContextValue;
...
declare const ResponsiveContainer: React__default.FC<ResponsiveContainerProps>;

/** 配送员今日统计 */
interface DeliveryDailyStats {
    /** 配送订单总数 */
    totalOrders: number;
    /** 已完成数 */
 ...
 */
declare const DeliveryPersonDashboard: React__default.FC<DeliveryPersonDashboardProps>;
 ...
 */
declare function TierUpgradePanel({ currentTier, nextTier, currentValue, unit, estimatedDays, metric, variant, style, 'data-testid': dataTestId, }: TierUpgradePanelProps): React__default.JSX.Element;
 ...
 * />
 */
declare function InventoryManagerDashboard({ metrics, slowMovingItems, supplierPerformances, categoryBreakdown, title, lastUpdatedAt, loading, className, }: InventoryManagerDashboardProps): React__default.JSX.Element;
...
/** 导购员工具面板 Props */
interface SalespersonToolPanelProps {
    /** 当前导购员姓名 */
...
declare function SalespersonToolPanel({ salespersonName, currentCustomer, preferences, recommendations, tasks, performance, loading, onSearchCustomer, onAddToCart, onShareProduct, onCompleteTask, onScan, className, }: SalespersonToolPanelProps): React__default.JSX.Element;
...
/** 面板属性 */
interface DataDriftMonitorPanelProps {
    /** 概览数据 */
...
declare function DataDriftMonitorPanel({ overview, features, title, loading, emptyText, warningThreshold, onFeatureClick, className, style, }: DataDriftMonitorPanelProps): React__default.JSX.Element;

/** 自动化触发条件类型 */
type TriggerConditionType = 'threshold' | 'pattern' | 'schedule' | 'anomaly' | 'composite';
/** 触发条件 */
...
/** 建议执行状态 */
type SuggestionStatus = 'pending' | 'applied' | 'dismissed' | 'in_progress';
/** 预期收益 */
...
/** 面板属性 */
interface AIAutomationSuggestionPanelProps {
...
declare const AIAutomationSuggestionPanel: React__default.FC<AIAutomationSuggestionPanelProps>;
 ...
 * ```
 */
declare function InfiniteScroll({ hasMore, onLoadMore, loading, loadingText, endText, threshold, disabled, loader, empty, children, className, style, direction, }: InfiniteScrollProps): React__default.JSX.Element;

interface UpgradeCondition {
    label: string;
    met: boolean;
}
interface UpgradeTierNode {
    /**
     * 等级标识
     */
    key: string;
...
interface MemberUpgradePathProps {
    /**
     * 从低到高的等级节点列表
     */
 ...
 */
declare function MemberUpgradePath({ tiers, currentTierKey, subtitle, }: MemberUpgradePathProps): React__default.JSX.Element;

type PointChangeType = 'earn_purchase' | 'earn_signin' | 'earn_review' | 'earn_referral' | 'earn_promotion' | 'spend_redeem' | 'spend_upgrade' | 'expire' | 'admin_adjust';
...
declare function MemberPointHistory({ records, totalPoints, totalEarnedThisMonth, totalSpentThisMonth, expiringSoon, className, onFilterChange, activeFilter, isLoading, }: MemberPointHistoryProps): React__default.JSX.Element;

type PrizeCategory = 'toy' | 'plush' | 'figure' | 'card' | 'snack' | 'other';
interface PrizeItem {
    id: string;
    name: string;
    /** 所需积分/票数 */
...
interface PrizeRedemptionCounterProps {
    /** 当前可用积分/票数 */
...
declare function PrizeRedemptionCounter({ availablePoints, prizes, selected, onSelectionChange, onRedeem, searchKeyword, categoryFilter, isProcessing, emptyText, }: PrizeRedemptionCounterProps): React__default.ReactElement;
 ...
 */
declare function sanitizeJsonLd(json: Record<string, unknown>): string;

export { type ABTestComparison, type ABTestRecord, AIAgentChatPanel, type AIAgentChatPanelProps, AIAgentPerformancePanel, type AIAgentPerformancePanelProps, AIAgentThinkingPanel, type AIAgentThinkingPanelProps, AIAgentToolCallPanel, type AIAgentToolCallPanelProps, AIAgentWorkloadDistributionPanel, type AIAgentWorkloadDistributionPanelProps, AIAnalysisInsightsPanel, type AIAnalysisInsightsPanelProps, AIAutomationSuggestionPanel, type AIAutomationSuggestionPanelProps, AICompetitiveAnalysisPanel, type AICompetitiveAnalysisPanelProps, type AICompetitiveSuggestion, AIDecisionComparisonPanel, type AIDecisionComparisonPanelProps, AIDecisionDistributionPanel, type AIDecisionDistributionPanelProps, AIDecisionEffectivenessBoard, type AIDecisionEffectivenessBoardProps, AIDecisionExplainerPanel, type AIDecisionExplainerPanelProps, AIDecisionOutcomeCard, type AIDecisionOutcomeCardProps, AIDecisionPanel, AIDecisionRuleChain, type AIDecisionRuleChainProps, AIDecisionTimeline, type AIDecisionTimelineProps, AIDemandForecastPanel, type AIDemandForecastPanelProps, AIDeviceFaultPredictionPanel, type AIDeviceFaultPredictionPanelProps, AIExecutionAuditPanel, type AIExecutionAuditPanelProps, type AIExecutionRecord, AIExperimentOptimizationPanel, type AIExperimentOptimizationPanelProps, AIMemberChurnPredictionPanel, type AIMemberChurnPredictionPanelProps, AIMemberLifecycleForecastPanel, type AIMemberLifecycleForecastPanelProps, AIMemberSegmentationPanel, type AIMemberSegmentationPanelProps, AIMetricGoalPanel, type AIMetricGoalPanelProps, type AIModelCapability, type AIModelOption, AIModelPerformancePanel, type AIModelPerformancePanelProps, type AIModelPricingTier, AIModelSelector, type AIModelSelectorProps, AIPricingRecommendationPanel, type AIPricingRecommendationPanelProps, AIRecommendationFeedbackPanel, type AIRecommendationFeedbackPanelProps, AIRuleWeightPanel, type AIRuleWeightPanelProps, AIScenarioSimulator, type AIScenarioSimulatorProps, AISmartInsightPanel, type AISmartInsightPanelProps, AISmartSchedulingPanel, type AISmartSchedulingPanelProps, AISuggestionCard, type AISuggestionCardProps, AISummaryCard, type AISummaryCardProps, Accordion, type AccordionItem, type AccordionProps, ActionPanel, type ActionPanelAction, type ActionPanelProps, type ActivityType, type AgentConclusion, type AgentLatencyBucket, type AgentPerformanceMetric, type AgentPerformanceSummary, type AgentStatusSummary, type AgentWorkload, AiABTestComparisonPanel, type AiABTestComparisonPanelProps, Alert, AlertCorrelationDashboard, type AlertCorrelationDashboardProps, type AlertCorrelationGroup, type AlertProps, type AlertSeverity, type AlertSource, type AlertState, type AlertTrendDataPoint, type AlertVariant, type AnalysisInsight, AnnouncementBanner, type AnnouncementBannerAction, type AnnouncementBannerProps, type AnnouncementSeverity, type AnnouncementVariant, type AnomalyAlert, AnomalyAlertPanel, type AnomalyAlertPanelProps, AnomalyAlertTrendPanel, type AnomalyAlertTrendPanelProps, AnomalyDiagnosisReport, type AnomalyDiagnosisReportProps, AnomalyFrequencyTimeline, type AnomalyFrequencyTimelineProps, type AnomalyPattern, AnomalyPatternPanel, type AnomalyPatternPanelProps, type AnomalyPatternType, type AnomalySeverity, type AnomalyTimeBucket, type Appointment, AppointmentBookingPanel, type AppointmentBookingPanelProps, type AppointmentStatus, ArcadeRevenueCard, type ArcadeRevenueCardProps, type AreaStatus, AssistantManagerDashboard, type AssistantManagerDashboardProps, type AsstQuickAction, AsyncSelect, type AsyncSelectProps, type AttachmentItem, AttachmentList, type AttachmentListProps, type AttachmentStatus, type AuditAction, type AuditEntry, type AuditEvent, type AuditFilter, type AuditSeverity, type AuditSummary, AuditTimeline, type AuditTimelineProps, AutoComplete, type AutoCompleteOption, type AutoCompleteProps, type AutomationAction, type AutomationSuggestion, Avatar, AvatarGroup, type AvatarGroupProps, type AvatarProps, type AvatarSize, type AvatarStatus, BREAKPOINTS, Badge, type BadgePlacement, type BadgeProps, type BadgeSize, type BadgeVariant, type BasketItem, type BatchAction, BatchSelectionBar, type BatchSelectionBarProps, type BookingParams, type BottomNavItem, BottomNavigation, type BottomNavigationProps, BranchSelector, type BranchSelectorNode, type BranchSelectorProps, Breadcrumb, type BreadcrumbItem, BreadcrumbPageHeader, type BreadcrumbPageHeaderAction, type BreadcrumbPageHeaderProps, type BreadcrumbProps, type BreakpointKey, type BreakpointValue, type BudgetOverview, type BudgetOverviewItem, type BulkEditEntry, type BulkEditField, BulkEditPanel, type BulkEditPanelProps, Button, type ButtonProps, type ButtonSize, type ButtonVariant, Calendar, type CalendarMarker, type CalendarProps, type CampaignDataPoint, type CampaignInsight, type CampaignMetric, CampaignPerformancePanel, type CampaignPerformancePanelProps, type CampaignSnapshot$1 as CampaignSnapshot, CampaignTrendForecast, type CampaignTrendForecastPoint, type CampaignTrendForecastProps, type CampaignTrendHistoricalPoint, type CampaignTrendImpactFactor, type CampaignTrendModelInfo, Caption, Card, Carousel, type CarouselProps, type CarouselSlide, Cascader, type CascaderOption, type CascaderProps, CashierPanel, type CashierPanelProps, type CashierShiftMetrics, type CashierStatus, type CategoryBreakdown, type CategoryStat, type CertificatePosture, type ChannelEffectiveness, Chart, type ChartDataPoint, ChartExportPanel, type ChartExportPanelProps, type ChartProps, type ChartType, type ChatMessage, type ChatMessageRole, type ChatMessageStatus, Checkbox, type CheckboxProps, type CheckboxSize, type CheckoutStatus, Chip, type ChipProps, type ChipSize, type ChipVariant, type ChurnPrediction, type ChurnRiskLevel, type ChurnSignalFactor, type CoachDailyMetrics, CoachDashboard, type CoachDashboardProps, CodeBlock, type CodeBlockProps, Collapse, type CollapseProps, type CollapseSize, type CollapseVariant, Collapsible, type CollapsibleProps, ColorPicker, type ColorPickerProps, type ColorValue, CombinedDetailPage, type CombinedDetailPageProps, Combobox, type ComboboxOption, type ComboboxProps, type CommandItem, CommandPalette, type CommandPaletteProps, type CommentAuthor, type CommentItem, CommentList, type CommentListProps, Compact, ComparisonBreakdownChart, type ComparisonBreakdownChartProps, type ComparisonItem, type CompetitorDimension, type CompetitorEntry, type CompetitorMetric, type ConciergeAction, ConciergePanel, type ConciergePanelProps, type ConfidenceInterval, type ConfidenceLevel, ConfigurationPosturePanel, type ConfigurationPosturePanelProps, ConfigurationVersionDiff, type ConfigurationVersionDiffProps, ConfirmActionDialog, type ConfirmActionDialogProps, ConfirmDialog, ContentSwitcher, type ContentSwitcherProps, type ContentSwitcherSegment, ContextMenu, type ContextMenuEntry, type ContextMenuItem, type ContextMenuProps, type ContextMenuSeparator, CopyToClipboard, type CorrelatedAlert, type CostBreakdownItem, CountUp, type CountUpProps, Countdown, type CountdownProps, type CountdownStatus, type CouponEntry, CouponRedemptionPanel, type CouponRedemptionPanelProps, type CouponStatus, type CouponType, Currency, type CustomerBrief, type CustomerInfo, type CustomerPreference, type CustomerProfile, CustomerServiceDashboard, type CustomerServiceDashboardProps, CustomerSessionPanel, type CustomerSessionPanelProps, type DailyPerformance, type DailyReceptionStats, DataDriftMonitorPanel, type DataDriftMonitorPanelProps, DataTable, type DataTableColumn, type DataTableSortConfig, DatePicker, type DatePickerProps, DateRangePicker, type DateRangePickerProps, type DateRangePreset, type DateRangeValue, DateTimePicker, type DateTimePickerMode, type DateTimePickerProps, DecisionAuditTrail, type DecisionAuditTrailProps, type DecisionCandidate, type DecisionCategory, type DecisionComparisonItem, type DecisionDistributionItem, type DecisionEffectivenessItem, type DecisionEvent, type DecisionFactor, type DecisionPanelConfig, type DecisionResult, type DecisionRuleResult, type DecisionSource, type DecisionStatus, type DecisionStep, type DecisionSummary, type DeliveryDailyStats, type DeliveryOrder, DeliveryPersonDashboard, type DeliveryPersonDashboardProps, type DemandForecastDimension, type DemandForecastEntry, type DescriptionItem, DescriptionList, type DescriptionListProps, DetailActionBar, type DetailActionBarAction, type DetailActionBarIcon, type DetailActionBarProps, DetailClosureBar, type DetailClosureBarProps, type DetailClosureLink, type DetailInfoRow, DetailShell, type DetailShellAction, type DetailTab, type DeviceCategory, type DeviceEntry, type DeviceFaultPrediction, type InspectionItem as DeviceInspectionItem, DeviceInspectionPanel, type DeviceInspectionPanelProps, type DevicePanelSummary, type DeviceStatus, DeviceStatusPanel, type DeviceStatusPanelProps, type DeviceStatusSummary, type DeviceType, type DiagnosisFinding, Dialog, type DialogProps, type DiffChangeType, type DiffEntry, type DiffSeverity, type DistrictStoreSnapshot, type DistrictSummary, Divider, type DividerOrientation, type DividerProps, type DividerVariant, DonutChart, type DonutChartProps, type DonutSlice, DotNavigation, type DotNavigationProps, type DotSize, type DotVariant, Drawer, type DrawerPlacement, type DrawerProps, type DriftFeature, type DriftOverview, type DrilldownDetail, type DrilldownDetailItem, DrilldownTrendCard, type DrilldownTrendCardProps, type TrendDirection as DrilldownTrendDirection, Dropdown, type DropdownItem, DropdownMenu, type DropdownMenuEntry, type DropdownMenuItem, type DropdownMenuProps, type DropdownMenuSeparator, type DropdownProps, type EffectivenessSummary, Empty, type EmptyProps, EmptyState, EntertainmentGuideDashboard, type EntertainmentGuideDashboardProps, ErrorBoundary, type ErrorBoundaryFallbackArgs, type ErrorBoundaryProps, type ErrorBoundarySeverity, type ExecutionStatus, type ExpectedBenefit, type ExperimentEntry, type ExperimentStatus, type ExperimentVariant, type ExplainabilityData, ExportButton, type ExportButtonProps, type ExportFormat, type FabPosition, type FabSize, type FactorType, type FaultPredictionSummary, type FaultSeverity, type FeedbackAggregate, type FeedbackEntry, FeedbackList, type FeedbackListProps, type FeedbackRating, type FeedbackSource, FeedbackWidget, type FeedbackWidgetProps, FileUpload, type FileUploadProps, FilterBar, type FilterChip, FilterChips, type FilterChipsProps, type FilterShortcut, FinanceManagerDashboard, type FinanceManagerDashboardProps, type FinanceSummary, type FinanceTransaction, FloatingActionButton, type FloatingActionButtonProps, type FollowUpCategory, type FollowUpClient, type FollowUpMember, type FollowUpPriority, type FollowUpRecord, type FollowUpTaskStatus, type ForecastAccuracy, type ForecastDataPoint, type ForecastModelMeta, type ForecastPoint, type ForecastTrend, FormField, type FormPageField, type FormPageFieldRule, FormPageScaffold, type FormPageScaffoldMeta, type FormPageScaffoldProps, type FormPageSubmitResult, FormSubmitFeedback, FoundationAlertAcknowledgeActionButton, FoundationAlertDemoListPage, FoundationAlertDetailView, FoundationAlertDetailsReadout, type FoundationAlertFilterState, type FoundationAlertFilterSummaryItem, type FoundationAlertGovernance, type FoundationAlertGovernanceAlert, FoundationAlertLinkedAlertGridReadout, FoundationAlertLinkedFocusBarReadout, type FoundationAlertLinkedOverviewCardDefinition, type FoundationAlertLinkedOverviewPalette, type FoundationAlertLinkedOverviewPanelRenderArgs, FoundationAlertLinkedOverviewSection, type FoundationAlertLinkedOverviewStatsPreset, FoundationAlertLinkedOverviewStatsReadout, type FoundationAlertLinkedOverviewSummaryLike, FoundationAlertLinkedOverviewSurface, type FoundationAlertLinkedOverviewSurfaceProps, FoundationAlertListPageSection, type FoundationAlertMutation, type FoundationAlertMutationAction, FoundationAlertOverviewReadout, type FoundationAlertOwnerSummaryItem, type FoundationAlertPanelClientAccess, FoundationAlertPanelFrame, FoundationAlertPanelOwnerSummaryReadout, type FoundationAlertPanelPalette, type FoundationAlertPanelReadoutPalette, FoundationAlertPanelSelectedAlertReadout, FoundationAlertPanelSourceSummaryReadout, FoundationAlertPanelSummaryDigestReadout, FoundationAlertPanelSurface, type FoundationAlertPanelSurfaceProps, type FoundationAlertPanelThemePreset, FoundationAlertPanelTimelineReadout, type FoundationAlertPanelToolbarPalette, FoundationAlertPresetDetailRoute, type FoundationAlertRecord, FoundationAlertRuntimeCallbackStalledReadout, type FoundationAlertSourceSummaryItem, FoundationAlertTableCard, type FoundationAlertTimelineItem, type FoundationAlertTimelineMetrics, FoundationConsumerWiringSection, type FoundationConsumerWiringSectionProps, FranchiseOperationsDashboard, type FranchiseOperationsDashboardProps, type FranchiseOverviewMetrics, type FranchiseStore, type FrontDeskMetrics, FrontDeskPanel, type FrontDeskPanelProps, FrontDeskSupervisorDashboard, type FrontDeskSupervisorDashboardProps, FunnelChart, type FunnelChartProps, type FunnelStage, type FunnelStep, GaugeChart, type GaugeChartProps, type GaugeSegment, type GovernanceAlert, GovernanceQuickViewSection, type GovernanceQuickViewSectionProps, type GovernanceReadModel, type GuestTask, type GuideAlert, type GuideDailyMetrics, type HSBColor, type HandoverCategory, type HandoverItem, Heading, type HeatmapCell, HeatmapChart, type HeatmapChartProps, type HeatmapColorScheme, type HighlightMetric, HoverCard, type HoverCardPlacement, type HoverCardProps, type ImageItem, ImagePreview, type ImagePreviewProps, type ImpactMetric, type InboundTask, InfiniteScroll, type InfiniteScrollProps, InfoCard, type InfoCardItem, type InfoCardProps, InfoRow, InlineNotification, type InlineNotificationProps, type InlineNotificationType, Input, InputNumber, type InputNumberProps, type InputNumberSize, type InputProps, type InputSize, type InputVariant, type InsightCategory, type InsightItem, type InsightSeverity, type InspectionAlert, type InspectionArea, type InspectionCategory, InspectionChecklist, type InspectionChecklistProps, type InspectionItem$1 as InspectionItem, type InspectionItemStatus, type InspectionMetrics, type InspectionResult, type InspectionSummary, type InspectionTask$1 as InspectionTask, type InspectorDailyMetrics, InventoryKeeperDashboard, type InventoryKeeperDashboardProps, InventoryManagerDashboard, type InventoryManagerDashboardProps, type InventoryMetrics, type IssueSeverity, KanbanBoard, type KanbanBoardProps, type KanbanCard, type KanbanColumn, type KeeperQuickAction, type KpiCardItem, type KpiItem, KpiSummaryCard, type KpiSummaryCardProps, Label, type LabelColor, type LabelProps, type LabelSize, type LabelWeight, type LifecycleStage, type ListPageFacetConfig, type ListPageFacetState, ListToolbar, type ListToolbarBatchAction, type ListToolbarFilterOption, type ListToolbarProps, type ListToolbarSortOption, type ListToolbarViewMode, LoadingOverlay, type LoadingOverlayProps, LoadingSkeleton, MOCK_TIER_DATA, MOCK_TIER_TOTAL, type MachineStats, type MachineStatus, type MarketerQuickAction, type CampaignSnapshot as MarketingCampaignSnapshot, type MarketingGrowthMetrics, type MarketingKpi, MarketingManagerDashboard, type MarketingManagerDashboardProps, type MarketingQuickAction, Masonry, type MasonryProps, type MemberActivity, MemberActivityCard, type MemberActivityCardProps, MemberFollowUpTaskPanel, type MemberFollowUpTaskPanelProps, type MemberGrowthMetrics, type MemberLevel, MemberLevelDistribution, type MemberLevelDistributionProps, type MemberLifecycleForecast, MemberMarketerDashboard, type MemberMarketerDashboardProps, MemberPointHistory, type MemberPointHistoryProps, type MemberQuickLookup, MemberRFMAnalysisPanel, type MemberRFMAnalysisPanelProps, MemberRechargePanel, type MemberRechargePanelProps, type MemberSegment, type MemberServiceOverview, type MemberTier, MemberTierDistribution, type MemberTierDistributionProps, MemberUpgradePath, type MemberUpgradePathProps, type MemberVisitRecord, type MentionItem, type MentionOption, Mentions, type MentionsProps, type MetricGoal, type MetricMode, type MetricTile, type MetricTrend, MetricsDashboardGrid, type MetricsDashboardGridProps, Modal, type ModalProps, type ModelPerformanceData, type ModelPerformanceMetric, MonthPicker, type MonthPickerProps, type MonthlyTarget, MultiSelect, type MultiSelectOption, type MultiSelectProps, type NavMenuItem, NavigationMenu, type NavigationMenuProps, type NotificationAction, NotificationBell, type NotificationItem$1 as NotificationBellItem, type NotificationBellProps, type NotificationCategory, NotificationCenter, type NotificationCenterProps, type NotificationItem, type NotificationSeverity, type NotificationSummary, NumberFormat, type NumberFormatProps, type NumberFormatSize, type NumberFormatType, OTPInput, type OTPInputProps, type OTPInputSize, type OTPInputVariant, OfflineBadge, type OfflineBadgeProps, type OfflineStatus, OperationsManagerDashboard, type OperationsManagerDashboardProps, type OpsQuickAction, type OptimizationSuggestion, type OutboundTask, type OverlayMode, PageShell, PaginatedDataTableCard, Pagination, Paragraph, PasswordInput, type PasswordInputProps, type PatternSeverity, type PaymentMethod, type PendingCertification, type PendingTask, Percent, type PerformanceCard, PerformanceRanking, type PerformanceRankingProps, type PersonalizedRecommendation, type PointChangeType, type PointRecord, type PointsTransaction, Popconfirm, type PopconfirmPlacement, type PopconfirmProps, Popover, type PopoverPlacement, type PopoverProps, PortalConsumerGovernanceSection, type PortalConsumerGovernanceSectionProps, PortalDomainGovernanceCard, type PortalDomainGovernanceCardProps, PortalList, type PortalListItemView, PredictionAnalysisPanel, type PredictionAnalysisPanelProps, type PredictionPoint, type PredictionStatus, type PredictionSummary, type PresetColor, type PricingRecommendation, type PricingSummary, type PrizeCategory, type PrizeItem, PrizeRedemptionCounter, type PrizeRedemptionCounterProps, ProcurementManagerDashboard, type ProcurementManagerDashboardProps, type ProcurementSummary, type ProductSnapshot as ProductDashboardSnapshot, type ProductGrowthMetrics, ProductManagerDashboard, type ProductManagerDashboardProps, type ProductQuickAction, type ProductRecommendation, type ProductSnapshot, ProfitMarginPanel, type ProfitMarginPanelProps, type ProfitMarginRecord, Progress, ProgressCard, type ProgressCardProps, type ProgressProps, ProgressRing, type ProgressRingProps, type ProgressSegment, ProgressSegments, type ProgressSegmentsProps, type PromoTask, type PropRental, type PurchaseOrderDetail, type PurchaseOrderLineItem, PurchaseOrderPanel, type PurchaseOrderPanelActions, type PurchaseOrderPanelProps, type PurchaseOrderSnapshot, QRCodeDisplay, type QRCodeDisplayProps, type QRCodeType, type QcTaskStatus, type QualityInspectionTask, QualityInspectorDashboard, type QualityInspectorDashboardProps, type QualityIssue, type QualityMetrics, type QueueItem, type QueueOverview, type QuickAction$2 as QuickAction, QuickActionBar, type QuickAction as QuickActionBarAction, type QuickActionBarProps, type QuickFnButton, type QuickStatItem, QuickStats, type QuickStatsProps, type RFMRecord, type RFMSegment, type RFMSegmentInfo, type RGBColor, RadarChart, type RadarChartProps, type RadarDimension, type RadarSeries, type RadioDirection, RadioGroup, type RadioGroupProps, type RadioOption, type RadioSize, type RankingItem, Rating, type RatingProps, RealTimeRevenueDisplay, type RealTimeRevenueDisplayProps, RealtimeKpiStrip, type RealtimeKpiStripProps, type ReasoningStep, type ReasoningStepStatus, type ReceiptData, type ReceiptHeader, type ReceiptLineItem, type ReceiptPayment, type PaymentMethod$1 as ReceiptPaymentMethod, ReceiptPreview, type ReceiptPreviewProps, type RechargePaymentMethod, type RechargePlan, type RechargeRecord, type RecommendationCategory, type RecommendationConfidence, type RecommendationSummary, type RecommendedProduct, type ReconciliationDiff, ReconciliationDiffPanel, type ReconciliationDiffPanelProps, ReconnectingBadge, type ReconnectingBadgeProps, type ReconnectingState, type RedemptionRecord, type RedemptionRequest, type RedemptionResult, type RedemptionSummary, type RegionStoreSnapshot, RegionalManagerDashboard, type RegionalManagerDashboardProps, type RegionalQuickAction, type RegionalSummary, ResourceOptimizationPanel, type ResourceOptimizationPanelProps, type ResourceOptimizationSuggestion, ResponsiveContainer, type ResponsiveContainerProps, Result, type ResultProps, type ResultStatus, type RetentionAction, type ReturnGoodsPanelCallbacks, type ReturnGoodsPanelConfig, type ReturnGoodsPanelProps, ReturnGoodsProcessingPanel, type ReturnItem, type ReturnRequest, type ReturnStatus, type ReturnType, type RevenueByCategory, type RevenueSnapshot, type RevenueTrendPoint, RichTextEditor, type RichTextEditorHandle, type RichTextEditorProps, type RichTextEditorSize, RolePadClient, type RolePadClientProps, type RouteStop, type RuleChainNode, type RuleExecutionStatus, type RuleNodeStatus, type RuleRecommendation, RuleRecommendationPanel, type RuleRecommendationPanelProps, type RuleWeightItem, type RuntimeGovernancePanelPreset, RuntimeGovernancePanelTemplate, RuntimeOperationDateTimeReadout, RuntimeOperationDemoListPage, RuntimeOperationDetailView, RuntimeOperationIdReadout, RuntimeOperationOverviewReadout, RuntimeOperationPresetDetailRoute, RuntimeOperationReceiptListReadout, type RuntimeOperationReceiptRecord, type RuntimeOperationRecord, RuntimeOperationStatusReadout, RuntimeOperationTargetReadout, RuntimeOperationTimelineReadout, RuntimeOperationToolbar, RuntimeOperationTypeReadout, RuntimeOperationsListPageSection, RuntimeOperationsTableCard, RuntimePanelFeedback, RuntimePanelFrame, RuntimePanelGrid, RuntimePresetCard, RuntimePresetSelector, RuntimeReceiptEvents, RuntimeReceiptStatusCard, SalesClerkTool, type SalesClerkToolProps, SalesConversionFunnel, type SalesConversionFunnelProps, SalesForecastPanel, type SalesForecastPanelProps, SalesGuideTool, type SalesGuideToolProps, type SalesScript, type SalesTask, SalespersonToolPanel, type SalespersonToolPanelProps, ScenarioComparisonPanel, type ScenarioComparisonPanelProps, type ScenarioItem, type ScenarioMetric, type ScenarioVariable, type ScheduleSlot, type SchedulingConstraint, type SchedulingConstraintType, type SchedulingRecommendation, ScrollArea, type ScrollAreaProps, ScrollToTop, type ScrollToTopProps, SearchFilterInput, type SecretPosture, SectionHeader, type SectionHeaderAction, type SectionHeaderProps, type SegmentAnalysis, SegmentedControl, type SegmentedControlProps, type SegmentedOption, Select, type SelectOption, type SelectProps, type ServiceItem$1 as ServiceItem, type ServiceQualityMetrics, type ServiceRecord, type ServiceTicket, type SessionAction, type SessionStatus, type ShiftAssignment, type ShiftHandover, type ShiftHandoverEntry, ShiftHandoverPanel, type ShiftHandoverPanelProps, type ShiftInfo, type ShiftSlot, type ShiftSummary, type ShiftType, type SideNavItem, SideNavigation, type SideNavigationProps, type SimulationResult, Skeleton, type SkeletonProps, Slider, type SliderProps, type SlowMovingItem, type SmartInsight, type SmartInsightCategory, type SmartInsightPriority, SmartTrendAnalysisPanel, type SmartTrendAnalysisPanelProps, SmartTrendChart, type SmartTrendChartProps, type SortableItem, SortableList, type SortableListProps, Space, type SpaceDirection, type SpaceProps, type SpaceSize, SparklineChart, type SparklineChartProps, type SparklineDataPoint, type SparklinePoint, SpeedDial, type SpeedDialAction, type SpeedDialProps, Spin, type SpinProps, type SpinSize, Spinner, type SpinnerProps, type SpinnerSize, type SpinnerVariant, type SplitDirection, SplitPane, type SplitPaneProps, type StaffPreference, type StaffScheduleEntry, type StaffShiftInfo, StaffShiftSchedulePanel, type StaffShiftSchedulePanelProps, type StageMetric, type StageTransitionAdvice, StatCard, StatTrend, type StatTrendProps, Statistic, type StatisticLayout, type StatisticProps, type StatisticSize, type StatisticVariant, StatusBadge, StatusBadgeGroup, type StepItem, type StepStatus, Stepper, type StepperProps, type StepperStep, Steps, type StepsOrientation, type StepsProps, type StepsSize, type StockAlert, type StoreComparisonItem, type StoreComparisonMetric, StoreComparisonPanel, type StoreComparisonPanelProps, type StoreDailyMetrics, type StoreGroup, type StoreItem, StoreManagerDashboard, type StoreManagerDashboardProps, StoreSelector, type StoreSelectorMode, type StoreSelectorProps, type StoreStatus, StoreStatusIndicator, type StoreStatusIndicatorProps, type StoreStatusSize, StoreTransferOrderPanel, type StoreTransferOrderPanelProps, type StrategyCondition, type StrategyConfig, StrategyConfigPanel, type StrategyConfigPanelProps, type StrategyParamDef, type StrategyParamOption, type StrategyParamType, SubmitButton, type SubmitButtonProps, type SubmitButtonVariant, type SuggestionItem, type SuggestionPriority, type SuggestionSource, type SuggestionStatus, type SupplierOverview, type SupplierPerformance, type SupportedPadRole, Switch, type SwitchProps, type SwitchSize, Table, type TableColumn, type TablePaginationState, type TableProps, type TableSortState, Tabs, Tag, TagGroup, TagInput, type TagInputProps, type TagProps, type TagVariant, type TestVariant, Text, type TextAlign, TextArea, type TextAreaProps, type TextAreaResize, type TextAreaSize, type TextColor, type TextTransform, type TextVariant, type TextWeight, type TierData, TierDistributionChart, type TierDistributionChartProps, type TierDistributionParams, type TierInfo, type TierLevel, type TierSummary, TierUpgradePanel, type TierUpgradePanelProps, type TillStatus, TimePicker, type TimePickerProps, type TimeRangeOption, type TimeSlot, Timeline, type TimelineItem, type TimelineItemVariant, type TimelineNodeStatus, type TimelineProps, ToastContainer, type ToastEntry, type ToastOptions, type ToastVariant, ToggleButton, type ToggleButtonProps, ToggleGroup, type ToggleGroupProps, type ToggleGroupSize, type ToggleGroupVariant, type ToggleOption, type ToolCallParameter, type ToolCallRecord, type ToolCallStatus, type ToolbarAction, type ToolbarPreset, Tooltip, type TooltipPlacement, type TooltipProps, Tour, type TourProps, type TourStep, type TrainingDailyMetrics, TrainingManagerDashboard, type TrainingManagerDashboardProps, type TrainingNeed, type TrainingProgress, type TrainingSession, type TransactionLog, Transfer, type TransferItem, type TransferOrder, type TransferProps, type TransferStatus, type TransitionAction, Tree, type TreeNode, type TreeProps, TreeSelect, type TreeSelectNode, type TreeSelectProps, type TrendAnalysis, type TrendDirection$2 as TrendAnalysisDirection, type TrendDataPoint, type TrendDirection$3 as TrendDirection, type TrendGranularity, type TrendDirection$1 as TrendIndicatorDirection, type TriggerCondition, type TriggerConditionType, Typography, type TypographyProps, type UpgradeCondition, type UpgradeTierNode, type UploadFile, type UsageMetric, UsageMetricsPanel, type UsageMetricsPanelProps, type UseAlertOptions, type UseToastReturn, type UserFeedbackItem, type VariantStats, type VenueAlert, type VenueRevenue, VenueSupervisorDashboard, type VenueSupervisorDashboardProps, type VenueTraffic, type ViewModelContextValue, ViewModelProvider, type ViewModelProviderProps, VirtualizedList, type VirtualizedListProps, type VirtualizedListRow, type WarehouseMetrics, WaterfallMasonry, type WaterfallMasonryProps, Watermark, type WatermarkContent, type WatermarkProps, WeekPicker, type WeekPickerProps, type WeightAdjustResult, WordCloudChart, type WordCloudChartProps, type WordCloudFontStrategy, type WordCloudItem, type WordCloudLayout, type WorkbenchBreadcrumb, WorkbenchHeader, type WorkbenchHeaderProps, type WorkbenchNavItem, WorkspaceBreadcrumb, type WorkspaceBreadcrumbProps, type WorkspaceBreadcrumbSegment, YearPicker, type YearPickerProps, type ZoneDeviceStatus, buildFoundationAlertDrilldownSections, buildFoundationAlertLytConnectionGovernanceSections, buildFoundationAlertRecordFromDrilldown, canReplayRuntimePanelAction, canReplayRuntimePanelReceipt, collectLeafIds, computeDeviceSummary, createFoundationAdminGovernanceStatsCopy, createFoundationAlertDetailMockMap, createFoundationAlertLinkedOverviewStats, createFoundationAlertMockRecords, createFoundationAlertNextNavigationBindings, createFoundationAlertPanelActionButtonStyle, createFoundationAlertPanelFeedbackStyle, createFoundationAlertPanelFilterButtonStyle, createFoundationAlertPanelFilterChipStyle, createFoundationAlertPanelSectionStyle, createFoundationAlertPanelSelectionButtonStyle, createFoundationAlertPanelShortcutCardStyle, createFoundationAlertPanelSummaryCardStyle, createFoundationAlertTableColumns, createRuntimeOperationDetailMockMap, createRuntimeOperationMockRecords, createRuntimeOperationTableColumns, createRuntimeOperationToolbarProps, createRuntimeReceiptStatusCard, createRuntimeReceiptStatusCardProps, describeRuntimeCallbackStalledEscalation, executeRuntimePanelOperation, findNodeById, formatFoundationAlertActionLabel, formatFoundationAlertDrilldownDateTime, formatRuntimeCallbackStalledDuration, foundationAdminGovernanceListPreset, foundationAdminGovernanceSourceLabels, foundationAlertDetailDemoPresets, foundationAlertListDemoPresets, foundationAlertPanelThemePresets, foundationAlertSeverityLabels, foundationAlertStatusLabels, getRuntimePanelTenantId, groupStoresByKey, hasRuntimePanelReceiptCode, joinRuntimeScopeSummary, listPageStatCardStyle, mapFoundationGovernanceAlertsToRecords, refreshFoundationAlertSelection, resolveBreakpoint, runtimeOperationDetailDemoPresets, runtimeOperationListDemoPresets, runtimeOperationStatusLabels, runtimeOperationStatusVariants, sanitizeHtml, sanitizeJsonLd, serializeToCsv, summarizeRuntimePanelReceipt, useAIRuleWeight, useAiABTestComparison, useAlert, useCountdown, useFormSubmit, useFoundationAlertDemoAcknowledge, useFoundationAlertDrilldownQuery, useFoundationAlertFocusSync, useFoundationAlertGovernanceState, useFoundationAlertLinkedFocusQuery, useFoundationAlertMutationController, useFoundationAlertTimelineQueryState, useFoundationAlertViewLinkController, useFoundationAsyncLoader, useListPageSectionState, useNotificationSummary, usePagination, useResponsive, useRuntimePanelState, useRuntimePresetSelection, useSearchFilter, useSortedItems, useTenantId, useTierDistribution, useToast, useUserId, useViewModel, validateFormFields };
