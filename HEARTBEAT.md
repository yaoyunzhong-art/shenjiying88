...
| 指标 | pulse#361 | pulse#362 | Δ |
|-----|:---------:|:---------:|:-:|
| Typecheck | **14/14** ✅ | **14/14** ✅ | 🟢 稳态维持(已连续5次全绿) |
| 新回归 | **0** | **0** | 🟢 无新回归(第5次) |
| storefront-web | ⚠️ 5✖(Promise pending已知) | ⚠️ 5✖ | 🟢 维持(已知) |
| tob-web | ❌ ELIFECYCLE+4✖ | ❌ ELIFECYCLE+4✖ | 🟢 维持(已知) |
| miniapp | ❌ ELIFECYCLE | ❌ ELIFECYCLE | 🟢 维持(已知) |
| admin-web | ⚠️ 3 ✖(已知) | ⚠️ 3 ✖(已知) | 🟢 维持(已知) |

### 🩺 健康摘要
- **✅ TSC稳态维持**: 连续5次14/14 ✅(pulse#358→#359→#360→#361→#362) — dispatch-358闭环成果保持
- **已知角色冒烟**: ⚠️ storefront(5✖已知)+tob(4✖+ELIFECYCLE)+miniapp(ELIFECYCLE)+admin(3✖) 维持
- **树哥派单**: 🔴 RQ-20260712-001~005 08:30派出→已过**7h仍未闭合**
- **dispatch闭环**: ✅ dispatch-358 已闭环保持(第5次验收) · 无新派单
- **连续🏆**: 0（TSC全通过但角色冒烟未全清）
- **知识库时效**: ✅ <24h ✅
