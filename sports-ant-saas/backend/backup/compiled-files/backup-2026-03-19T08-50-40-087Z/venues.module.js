...
var venue_search_service_1 = require("./venue-search.service");
var venues_controller_1 = require("./venues.controller");
var venue_search_controller_1 = require("./venue-search.controller");
...
var VenuesModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [venues_controller_1.VenuesController, venue_search_controller_1.VenueSearchController],
    ...
    var _classThis;
    var VenuesModule = _classThis = /** @class */ (function () {
        function VenuesModule_1() {
        }
        return VenuesModule_1;
    }());
    __setFunctionName(_classThis, "VenuesModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        VenuesModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return VenuesModule = _classThis;
}();
