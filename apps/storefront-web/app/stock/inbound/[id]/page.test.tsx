/**
 * apps/storefront-web/app/stock/inbound/[id]/page.tsx — L1 冒烟测试
 * 角色视角: 🏭库房管理员
 * 覆盖: 正例·反例·边界
 */
...
describe('StockInboundDetail — 正例', () => {
...
describe('StockInboundDetail — 反例', () => {
