/**
 * apps/storefront-web/app/device-inspection/[id]/page.tsx — L1 冒烟测试
 * 角色视角: 🔧设备巡检员 / 🎯运营专员
 * 覆盖: 正例·反例·边界
 */
...
describe('DeviceInspectionDetail — 正例', () => {
...
describe('DeviceInspectionDetail — 反例', () => {
...
describe('DeviceInspectionDetail — 边界', () => {
