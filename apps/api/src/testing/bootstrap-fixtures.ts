import { foundationSupportedClients } from '@m5/types'

export function createContractTestFoundationDependencySummary() {
  return {
...
export function createE2EFoundationDependencySummary() {
  return {
    dependsOn: ['identity-access', 'configuration-governance'],
...
export function createMarketProfileFixture() {
  return {
...
export function createRegionalOverridesFixture() {
  return [
    {
      scopeType: 'TENANT',
...
export function createTenantPortalFixture() {
  return {
    audience: 'TOB',
    scopeType: 'TENANT',
    scopeCode: 'tenant-demo',
...
export function createBrandPortalFixture() {
  return {
    audience: 'TOB',
    scopeType: 'BRAND',
    scopeCode: 'brand-demo',
...
export function createStorePortalFixture() {
  return {
    audience: 'TOC',
    scopeType: 'STORE',
    scopeCode: 'store-001',
...
export function createMinimalTenantContextFixture() {
  return {
    tenantId: 'tenant-demo'
  }
}

export function createResolvedTenantContextFixture() {
  return {
    tenantId: 'tenant-demo',
    brandId: 'brand-demo',
    storeId: 'store-001',
...
export function createSupportedClientsFixture() {
  return [...foundationSupportedClients]
}
