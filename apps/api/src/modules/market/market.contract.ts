import type { MarketProfile, RegionalConfigOverride } from '@m5/domain'
import type { MarketProfileContract, RegionalConfigOverrideContract } from '@m5/types'

export function toMarketProfileContract(profile: MarketProfile): MarketProfileContract {
  return {
...
export function toRegionalConfigOverrideContract(
  override: RegionalConfigOverride
): RegionalConfigOverrideContract {
  return {
