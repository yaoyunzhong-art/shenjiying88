...
export class ResilienceOperationsService {
  private readonly observabilitySignals: ObservabilitySignalRecord[] = [
    {
      signal: 'metrics',
      status: 'healthy',
      coverage: 96,
  ...
  private readonly retryPolicies: RetryPolicyRecord[] = [
    {
      key: 'edge-sync-retry',
  ...
  private readonly recoveryPlans: RecoveryPlanRecord[] = [
    {
