...
describe('MetricsService — 注册', () => {
  test('registerCounter 注册并返回 counter', () => {
  ...
  test('registerGauge 注册并返回 gauge', () => {
    const svc = freshService()
  ...
  test('registerHistogram 注册并返回 histogram', () => {
    const svc = freshService()
