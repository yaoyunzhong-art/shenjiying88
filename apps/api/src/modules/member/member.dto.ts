 ...
 * 会员 Bootstrap 响应 DTO
 */
export class MemberBootstrapResponseDto {
 ...
 * 会员持久化注册 DTO
 */
export class MemberPersistentRegisterDto {
  /** 登录手机号 */
  mobile!: string
  /** 会员昵称 */
  nickname!: string
 ...
 * 会员支付活动 DTO
 */
export class MemberPaymentActivityDto {
  /** 订单 ID */
  orderId!: string
  /** 支付金额 */
  amount!: number
 ...
 * 会员状态调整 DTO
 */
export class MemberStatusAdjustDto {
  /** 目标状态 */
  status!: MemberStatus
  /** 已审批工单号 */
  approvalTicket?: string
 ...
 * 持久化会员基础资料更新 DTO
 */
export class MemberPersistentProfileUpdateDto {
  /** 会员昵称 */
  nickname!: string
  /** 登录手机号 */
  mobile!: string
