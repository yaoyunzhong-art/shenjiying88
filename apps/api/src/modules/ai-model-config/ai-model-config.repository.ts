    ...
    const presets: AiModelPreset[] = [
      {
        ...
        industry: 'general', presetId: 'preset-gpt4o-general', name: 'GPT-4o (通用)', industryType: 'general', isActive: true, description: 'OpenAI GPT-4o,通用场景,推荐默认',
      ...
      },
      {
        ...
        industry: 'arcade', presetId: 'preset-claude-game', name: 'Claude 3.5 Sonnet (电玩行业)', industryType: 'arcade', isActive: true, description: '电玩游乐行业微调',
        createdAt: now, updatedAt: now,
      },
      {
        ...
        industry: 'family-entertainment', presetId: 'preset-qwen-family', name: 'Qwen-VL (亲子娱乐)', industryType: 'family-entertainment', isActive: true, description: '亲子娱乐场景',
        createdAt: now, updatedAt: now,
      },
      {
        ...
        industry: 'general', presetId: 'preset-custom', name: 'Custom 自定义', industryType: 'general', isActive: true, description: '门店自填 endpoint + apiKey',
        createdAt: now, updatedAt: now,
      },
    ]
