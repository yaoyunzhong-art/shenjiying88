...
const mockService = {
  ...
  createReconciliationTransaction: (ctx: TenantCtx, body: unknown): any => ({ id: 'txn-1', ...body as object }),
  listReconciliationTransactions: (ctx: TenantCtx, query: unknown) => [],
  getReconciliationTransaction: (id: string, ctx: TenantCtx) => ({ id }),
  updateReconciliationTransaction: (id: string, ctx: TenantCtx, body: unknown): any => ({ id, ...body as object }),
