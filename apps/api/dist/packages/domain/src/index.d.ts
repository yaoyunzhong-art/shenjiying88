...
export declare enum ClientChannel {
    Pc = "PC",
    Pad = "PAD",
    H5 = "H5",
    MiniApp = "MINIAPP",
...
export declare enum PortalAudience {
    ToC = "TOC",
    ToB = "TOB"
}
export declare enum PortalScopeType {
    Tenant = "TENANT",
    Brand = "BRAND",
    Store = "STORE"
}
export declare enum PortalChannel {
    Web = "WEB",
    H5 = "H5",
    MiniApp = "MINIAPP",
    App = "APP",
...
export declare enum StorefrontSurface {
...
export declare enum NetworkRegion {
...
export declare enum ConfigInheritanceMode {
...
export type StructuredValue = string | number | boolean | null | StructuredValue[] | {
...
export declare enum IdentitySubjectType {
...
export declare enum PolicySubjectType {
    Role = "ROLE",
    User = "USER",
    Group = "GROUP",
    ServiceAccount = "SERVICE_ACCOUNT",
...
export declare enum PolicyConditionOperator {
    Eq = "EQ",
    NotEq = "NOT_EQ",
    In = "IN",
    NotIn = "NOT_IN",
...
export declare enum EdgeNodeStatus {
    Online = "ONLINE",
    Offline = "OFFLINE",
    Degraded = "DEGRADED",
    Maintenance = "MAINTENANCE"
}
export declare enum EdgeSyncDirection {
    Upstream = "UPSTREAM",
    Downstream = "DOWNSTREAM",
    Bidirectional = "BIDIRECTIONAL"
}
export declare enum FileAssetKind {
    Avatar = "AVATAR",
    Image = "IMAGE",
    Video = "VIDEO",
    Document = "DOCUMENT",
...
export declare enum OpenPlatformAppType {
    Internal = "INTERNAL",
    Isv = "ISV",
    Partner = "PARTNER"
}
...
export declare enum AiExecutionStatus {
    Pending = "PENDING",
    Succeeded = "SUCCEEDED",
    Failed = "FAILED",
    Escalated = "ESCALATED"
