...
(0, node_test_1.default)('e2e: GET /finance/invoices — 查询发票列表', async () => {
    ...
    try {
        await (0, supertest_1.default)(app.getHttpServer())
            .post('/finance/invoices')
            .set(TENANT_A)
            .send({ orderId: 'o1', amount: 100, type: finance_entity_1.InvoiceType.Regular });
        await (0, supertest_1.default)(app.getHttpServer())
            .post('/finance/invoices')
            .set(TENANT_A)
            .send({ orderId: 'o2', amount: 200, type: finance_entity_1.InvoiceType.Regular });
...
//# sourceMappingURL=finance.e2e.test.js.map