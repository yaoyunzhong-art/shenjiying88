...
export declare enum LoyaltySettlementStatus {
    Succeeded = "SUCCEEDED",
    Failed = "FAILED"
}
...
export declare enum BlindboxFulfillmentStatus {
    Fulfilled = "FULFILLED",
    Skipped = "SKIPPED",
    Revoked = "REVOKED"
}
...
export declare enum LoyaltyPlanStatus {
    Draft = "DRAFT",
    Active = "ACTIVE",
    Paused = "PAUSED",
    Expired = "EXPIRED"
...
//# sourceMappingURL=loyalty.entity.d.ts.map