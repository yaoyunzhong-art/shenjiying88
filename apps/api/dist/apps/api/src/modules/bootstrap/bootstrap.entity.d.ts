 ...
 * 构造 Bootstrap 健康响应
 */
export declare function toBootstrapHealth(overrides?: Partial<BootstrapHealth>): BootstrapHealth;
/**
 * 构造 Bootstrap 元数据
 */
export declare function toBootstrapMetadata(tenantContext: RequestTenantContext, overrides?: Partial<BootstrapMetadata>): BootstrapMetadata;
//# sourceMappingURL=bootstrap.entity.d.ts.map