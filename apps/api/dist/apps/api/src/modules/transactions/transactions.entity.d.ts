...
import type { BlindboxFulfillment, CouponRedemption, LoyaltyOrderSettlement, PointsLedgerEntry } from '../loyalty/loyalty.entity';
export declare enum TransactionRefundStatus {
    Pending = "PENDING",
    Rejected = "REJECTED",
    Completed = "COMPLETED"
}
export declare enum TransactionRefundReviewAction {
    Approve = "APPROVE",
    Reject = "REJECT"
}
export declare enum TransactionRefundAgingBucket {
    Under1Hour = "UNDER_1H",
    Hour1To4 = "H1_TO_H4",
    Hour4To24 = "H4_TO_H24",
    Over24Hours = "GTE_24H"
}
export declare enum TransactionRefundRiskLevel {
    Low = "LOW",
    Medium = "MEDIUM",
    High = "HIGH"
}
export declare enum TransactionRefundEscalationLevel {
    None = "NONE",
    TeamLead = "TEAM_LEAD",
    OpsManager = "OPS_MANAGER",
    Finance = "FINANCE"
}
export declare enum TransactionRefundDispatchReason {
...
export declare enum TransactionRefundAssignmentAction {
    Assign = "ASSIGN",
    Claim = "CLAIM"
}
...
//# sourceMappingURL=transactions.entity.d.ts.map