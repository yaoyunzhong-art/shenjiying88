...
exports.ROLE_BOOTSTRAP_CONFIGS = exports.COACH_BOOTSTRAP = exports.WAREHOUSE_BOOTSTRAP = exports.FINANCE_BOOTSTRAP = exports.OPERATIONS_BOOTSTRAP = exports.SUPER_ADMIN_BOOTSTRAP = exports.ROLE_CAPABILITY_MAP = exports.WORKBENCH_CAPABILITIES = exports.NavItemPriority = void 0;
exports.hasCapability = hasCapability;
exports.makeWorkbenchBootstrapState = makeWorkbenchBootstrapState;
exports.getRoleBootstrapConfig = getRoleBootstrapConfig;
exports.canAccessRoleMenu = canAccessRoleMenu;
/**
 * 导航项优先级枚举
 */
var NavItemPriority;
(function (NavItemPriority) {
    NavItemPriority["High"] = "HIGH";
    NavItemPriority["Medium"] = "MEDIUM";
    NavItemPriority["Low"] = "LOW";
})(NavItemPriority || (exports.NavItemPriority = NavItemPriority = {}));
/**
 * 角色工作台能力标识
 */
exports.WORKBENCH_CAPABILITIES = [
    'tenant-management',
    'brand-matrix',
...
function hasCapability(role, capability) {
    const caps = exports.ROLE_CAPABILITY_MAP[role];
    if (!caps)
        return false;
 ...
 * 构造默认引导状态
 */
function makeWorkbenchBootstrapState(workbenches, overrides = {}) {
    return {
        version: '1.0.0',
        workbenches,
        initialized: true,
...
/** 所有角色引导配置聚合 */
exports.ROLE_BOOTSTRAP_CONFIGS = {
    SUPER_ADMIN: exports.SUPER_ADMIN_BOOTSTRAP,
    OPERATIONS: exports.OPERATIONS_BOOTSTRAP,
    FINANCE: exports.FINANCE_BOOTSTRAP,
    WAREHOUSE: exports.WAREHOUSE_BOOTSTRAP,
    COACH: exports.COACH_BOOTSTRAP
};
/**
 * 获取角色引导配置
 */
function getRoleBootstrapConfig(role) {
    return exports.ROLE_BOOTSTRAP_CONFIGS[role];
}
/**
 * 检查角色是否可访问目标角色的菜单（越权检查）
 */
function canAccessRoleMenu(actorRole, targetMenuRole) {
    // 自角色可访问
    if (actorRole === targetMenuRole)
        return true;
    // SUPER_ADMIN 可访问所有
...
//# sourceMappingURL=workbench.entity.js.map