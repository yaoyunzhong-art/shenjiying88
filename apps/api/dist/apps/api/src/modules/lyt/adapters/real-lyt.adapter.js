...
let RealLytAdapter = class RealLytAdapter extends http_lyt_adapter_base_1.HttpLytAdapterBase {
    constructor(configService) {
        const config = (0, lyt_adapter_config_1.resolveLytHttpAdapterConfig)('real', configService);
        super({
...
exports.RealLytAdapter = RealLytAdapter;
exports.RealLytAdapter = RealLytAdapter = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], RealLytAdapter);
//# sourceMappingURL=real-lyt.adapter.js.map