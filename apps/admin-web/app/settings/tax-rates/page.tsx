...
export default async function TaxRatesPage() {
  ...
  const sourceEvidence = {
    ...
    controlPlaneSource:
      'TaxRatesPage -> loadTaxRatesSnapshot -> DEFAULT_TAX_RATES/DEFAULT_TAX_RULES',
    businessDataSource: 'local tax governance fallback samples',
    refreshPath: 'TaxRatesPage -> loadTaxRatesSnapshot',
  ...
  return (
    <AdminPermissionGate {...permissionGate}>
      <div style={shellStyle}>
        ...
        <TaxRatesClient snapshot={snapshot} />
      </div>
    </AdminPermissionGate>
  )
}
