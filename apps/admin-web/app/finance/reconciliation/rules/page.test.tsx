...
describe('ReconciliationRulesPage — 来源态透明化', () => {
  ...
  it('应同时固证 api 与 fallback 来源标签', () => {
    assert.ok(PAGE_SRC.includes('loadReconciliationRulesSnapshot -> finance/reconciliation/rules'))
    assert.ok(PAGE_SRC.includes('loadReconciliationRulesSnapshot -> defaultRules fallback'))
