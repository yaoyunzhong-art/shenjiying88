...
const permissionGate = {
  ...
  title: 'SEO 元数据管理访问受限',
  description:
    'SEO 元数据管理页已接入管理员本地 session，只有具备 dashboard:read 的账号才能查看页面元数据、搜索结果与编辑面板。',
} as const
    ...
    <AdminPermissionGate {...permissionGate}>
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="flex gap-2 mb-4">
          ...
          <select value={sortKey} onChange={e => setSortKey(e.target.value as 'path' | 'title')} className="border rounded px-2 py-1.5 text-sm">
