...
const CLIENT_SRC = readFileSync(resolve(DIR, 'marketing-detail-client.tsx'), 'utf-8')
...
describe('marketing/[id] 结构固证', () => {
  it('page 应切为最小 server wrapper 并加载快照', () => {
    ...
    assert.ok(PAGE_SRC.includes('export default async function MarketingCampaignDetailPage'))
  ...
  it('data 应定义 mock 快照合同', () => {
    ...
    assert.ok(DATA_SRC.includes('loadMarketingDetailSnapshot'))
  })
})
