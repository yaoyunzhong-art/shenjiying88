...
export default function AnalyticsClient({ data }: { data: AnalyticsSnapshot }) {
    ...
    <div style={{ display: 'grid', gap: 24 }}>
      ...
      {activeTab === 'overview' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <Card title="营收趋势" style={{ padding: 16 }}>
          ...
          <Card title="客户画像" style={{ padding: 16 }}>
      ...
      {/* 商品排行 */}
      {activeTab === 'products' && (
        <Card title="热销商品 Top 5" style={{ padding: 16 }}>
      ...
      {/* 时段分析 */}
      {activeTab === 'hourly' && (
        <Card title="客流时段分布" style={{ padding: 16 }}>
