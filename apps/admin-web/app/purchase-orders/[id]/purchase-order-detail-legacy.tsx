...
const permissionGate = {
  requiredPermission: 'purchase-orders:id:read',
  title: 'purchase-orders 访问受限',
  description: '该页面已接入管理员权限管控，仅具备 purchase-orders:id:read 权限的账号可访问。',
} as const

export default function PurchaseOrderDetailLegacy({ id }: { id: string }) {
  const item = MOCK_PURCHASE_ORDERS.find((po: PurchaseOrderItem) => po.id === id);
