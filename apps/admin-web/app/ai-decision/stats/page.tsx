...
export default async function AiDecisionStatsPage() {
  ...
  const sourceEvidence = {
    ...
    controlPlaneSource: 'loadAiDecisionStatsSnapshot -> MOCK_RULES',
    businessDataSource: 'local AI decision sample stats',
    refreshPath: 'AiDecisionStatsPage -> loadAiDecisionStatsSnapshot',
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr style={{ borderBottom: '1px solid rgba(148,163,184,0.12)' }}>
                  <th
                    style={{ textAlign: 'left', padding: '8px 12px', color: '#94a3b8', fontWeight: 500 }}
                  >
                    规则名称
                  </th>
                  <th
                    style={{ textAlign: 'right', padding: '8px 12px', color: '#94a3b8', fontWeight: 500 }}
                  >
                    执行次数
                  </th>
                  <th
