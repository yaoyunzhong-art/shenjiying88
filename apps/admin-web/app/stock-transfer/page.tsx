...
type TransferStatus = 'pending' | 'approved' | 'shipped' | 'received' | 'rejected' | 'cancelled';
...
const STATUS_STYLE: Record<TransferStatus, StatusVariant> = {
  pending: 'warning' as StatusVariant,
  approved: 'success' as StatusVariant,
  shipped: 'neutral' as StatusVariant,
  received: 'success' as StatusVariant,
  rejected: 'danger' as StatusVariant,
  cancelled: 'neutral' as StatusVariant,
};
...
const URGENCY_VARIANT: Record<UrgencyLevel, StatusVariant> = {
  normal: 'neutral' as StatusVariant,
  urgent: 'warning' as StatusVariant,
  critical: 'danger' as StatusVariant,
};

// ---- Mock 数据 ----

const MOCK_TRANSFERS: StockTransferItem[] = [
