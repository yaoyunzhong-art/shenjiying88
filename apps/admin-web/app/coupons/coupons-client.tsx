...
import LegacyView from './coupons-legacy'
import type { CouponsPageSnapshot } from './coupons-page-data'
...
export default function CouponsClient({ snapshot }: { snapshot: CouponsPageSnapshot }) {
