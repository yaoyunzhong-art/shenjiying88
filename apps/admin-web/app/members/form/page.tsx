...
const permissionGate = {
  ...
  title: '会员等级权益配置访问受限',
  description: '会员等级权益配置页已接入管理员本地 session，只有具备 member:read 的账号才能查看等级分类、权益配置与校验结果。',
} as const;

export const dynamic = 'force-dynamic';
export const revalidate = 0;

export default async function MemberTierFormPage() {
  ...
  return (
    <AdminPermissionGate {...permissionGate}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: 24 }}>
        ...
        <MemberTierFormClient snapshot={snapshot} />
      </div>
    </AdminPermissionGate>
  );
}
