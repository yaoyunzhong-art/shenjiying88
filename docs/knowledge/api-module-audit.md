...
| logistics | SSE后勤：巡检任务/提醒/结果记录 + 清洁排班/考勤 + 维修工单派单/验收 + 物料申领审批/出库 | 5 | P-30 (SSE后勤)核心 |
...
3. **P-30 SSE后勤已补 logistics 四主链** — `RQ-30-01` 巡检、`RQ-30-02` 清洁排班、`RQ-30-03` 维修工单、`RQ-30-04` 物料申领均已闭环，`reservation` 仅保留为通用状态机底座
