...
| finance | P-38 | 财务对账：AI记账/自动对账/分账 | 57 | ⬜ 待开发 |
| coupon | P-48 | 联名券：AI自动发放/核销/活动统计 | 27 | ⬜ 待开发 |
| loyalty | P-48 | 忠诚度计划：积分/盲盒/优惠券计划 | 22 | ⬜ 待开发 |
| brand-custom | P-47 | 品牌运营：品牌定制/主题/域名/邮件模板 | 20 | ⬜ 待开发 |
| tenant | P-31 | 多租户隔离：租户上下文/隔离守护 | 44 | ⬜ 待开发 |
| deploy | P-53 | 部署管理：部署计划/Helm/成本估算 | 20 | ⬜ 待开发 |
| open-api | P-49 | 开放平台：OAuth2/API密钥/签名验证 | 17 | ⬜ 待开发 |
| openapi | P-49 | 开放平台二代：API Key生成/密钥管理 | 46 | ⬜ 待开发 |
| tenant-llm | P-49 | 智能体接入：租户LLM网关/多语言地理服务 | 24 | ⬜ 待开发 |
...
| content | 内容管理：内容运营 | 18 | P-47 (品牌运营)延伸 |
...
| marketing | 营销管理:A/B测试/营销活动 | 37 | P-47 (品牌运营)延伸 |
