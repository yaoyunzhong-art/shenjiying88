# 🎯 E2E链分级文档 — L0/L1/L2/L3

> 版本: v2.1 (基于58链 + L3页面基线)
> 生成: 2026-07-21 21:00 · 树哥E2E链分级
...
| **L3** | **2** | 页面性能基线 — 收银/会员首屏 ≤300ms | **每日** | ⚠️ 需人工确认 |
| **总计** | **60** | | | |
...
> **判定规则**: 最高频前台页面首屏加载 ≤300ms (FCP/LCP)。
> 失败影响: ⚠️ 需人工确认，记录到性能优化看板。

| # | 文件 | 标题 | it数 | 覆盖场景 |
|:-:|:-----|:-----|:----:|:---------|
| 1 | `e2e-l3-baseline-storefront-cashier` | 收银页 300ms 首屏基线 | 7 | FCP/结算按钮/商品列表/金额区域/支付方式/LCP/骨架屏 |
| 2 | `e2e-l3-baseline-storefront-member` | 会员页 300ms 首屏基线 | 7 | FCP/列表行/搜索栏/新增按钮/LCP/骨架屏/会员中心 |
| | **小计** | | **14** | |
